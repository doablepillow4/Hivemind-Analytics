  ...
  return [
    {
      ...
      description:
        "Escalating tensions near the Strait of Hormuz raise concerns over supply disruption.",
      url: "#",
      source: "Hivemind",
      publishedAt: now,
      sentiment: "bearish",
    ...
    },
    {
      ...
      description: "Federal Reserve speakers push back on early easing expectations.",
      url: "#",
      source: "Hivemind",
      publishedAt: now,
      sentiment: "bearish",
    ...
    {
      id: "fb-3",
      title: "Ukraine-Russia Ceasefire Talks Stall, Markets on Edge",
      description: "Diplomatic efforts hit a roadblock as both sides maintain hardline positions.",
      url: "#",
      source: "Hivemind",
      publishedAt: now,
      sentiment: "bearish",
    ...
    },
    {
      ...
      description: "Weaker-than-expected Chinese output data adds to global growth concerns.",
      url: "#",
      source: "Hivemind",
      publishedAt: now,
      sentiment: "bearish",
    ...
    },
    {
      ...
      description: "Reports of progress on transatlantic trade framework lift equities.",
      url: "#",
      source: "Hivemind",
      publishedAt: now,
      sentiment: "bullish",
    ...
    {
      id: "fb-6",
      title: "OPEC+ Maintains Output Cuts Through Next Quarter",
      description: "Cartel reaffirms production discipline keeping oil supported.",
      url: "#",
      source: "Hivemind",
      publishedAt: now,
      sentiment: "neutral",
